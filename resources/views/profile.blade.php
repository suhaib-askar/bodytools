				...
				<div class="panel-block">
					<form class="form" style="width: 100%;" role="form" method="PUT" action="{{ url('/profile') }}">
						...
						<div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
							...
							<div class="control">
								<select id="dobmonth" name="dobmonth" class="input select">
								...
								<input type="text" id="dobday" name="dobday" class="input" placeholder="Day" size="5" />
								<input type="text" id="dobyear" name="dobyear" class="input" placeholder="Year" size="10" />
